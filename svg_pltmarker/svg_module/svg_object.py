...
class SVGObject:
    ...
    SVG_GRPAHIC_ELEMENTS: Dict[str, Any] = {
        "circle": SVGCircle,
        "ellipse": SVGEllipse,
        "line": SVGLine,
        "path": SVGPath,
    ...
    def __init__(
        ...
        Args:
            svgstr (Optional[str], optional): The SVG string. Defaults to None.
            filepath (Optional[str], optional): The path to the SVG file. Defaults to None.
            url (Optional[str], optional): The URL to the SVG file. Defaults to None.
        ...
        while elements_queue:  # DFS
            ...
            if cur_node.nodeType == cur_node.ELEMENT_NODE:
                elements_queue.extend(cur_node.childNodes)
